...
#  opp_makemake -f -r --deep -o CastaliaBin -u Cmdenv -P /home/darthrev/Castalia -M release -X Simulations -X out -X bin
#
...
INCLUDE_PATH = \
    ...
    -Isrc/node/application/floodingApplication \
...
OBJS = \
    ...
    $O/src/node/application/floodingApplication/FloodingApplication.o \
    ...
    $O/src/node/application/floodingApplication/FloodingPacket_m.o \
...
MSGFILES = \
    ...
    src/node/application/floodingApplication/FloodingPacket.msg \
...
clean:
	...
	$(Q)-rm -f ./*_m.cc ./*_m.h
	$(Q)-rm -f Castalia/*_m.cc Castalia/*_m.h
	...
	$(Q)-rm -f src/node/application/floodingApplication/*_m.cc src/node/application/floodingApplication/*_m.h
...
$O/src/node/application/connectivityMap/ConnectivityMap.o: src/node/application/connectivityMap/ConnectivityMap.cc \
  ...
  src/node/communication/radio/RadioSupportFunctions.h \
  src/helpStructures/TimerServiceMessage_m.h
$O/src/node/application/floodingApplication/FloodingApplication.o: src/node/application/floodingApplication/FloodingApplication.cc \
  src/node/application/floodingApplication/FloodingApplication.h \
  src/node/application/floodingApplication/FloodingPacket_m.h \
  src/node/communication/radio/Radio.h \
  src/node/sensorManager/SensorManagerMessage_m.h \
  src/node/resourceManager/resourceManager/ResourceManager.h \
  src/helpStructures/DebugInfoWriter.h \
...
$O/src/node/communication/routing/floodRouting/FloodRouting.o: src/node/communication/routing/floodRouting/FloodRouting.cc \
  ...
  src/node/communication/radio/Radio.h
$O/src/node/communication/routing/floodRouting/FloodRoutingPacket_m.o: src/node/communication/routing/floodRouting/FloodRoutingPacket_m.cc \
  src/node/communication/routing/floodRouting/FloodRoutingPacket_m.h \
  src/node/communication/routing/RoutingPacket_m.h
